...
# Build information
SOLUTION_NAME = "Simple.Owin.HttpsOnly"
SOLUTION_DESC = "Tiny middleware for OWIN to redirect all HTTP requests to HTTPS."
SOLUTION_LICENSE = "http://www.opensource.org/licenses/mit-license.php"
SOLUTION_URL = "http://github.com/simple-owin/Simple.Owin.HttpsOnly"
SOLUTION_COMPANY = "Mark Rendle"
SOLUTION_COPYRIGHT = "Copyright (C) Mark Rendle 2013"
...
# Files
ASSEMBLY_INFO = "#{SOURCE_PATH}/Simple.Owin.HttpsOnly/Properties/AssemblyInfo.cs"
SOLUTION_FILE = "#{SOURCE_PATH}/Simple.Owin.HttpsOnly.sln"
